...
int s21_is_less(s21_decimal value_1, s21_decimal value_2) {
  ...
  int pow_1 = s21_get_scaling_f(value_1.bits[3]);
  int pow_2 = s21_get_scaling_f(value_2.bits[3]);
  int scale = pow_1 - pow_2;
  if (!s21_overflow(((scale > 0) ? &value_2 : &value_1), abs(scale))) {
